...
<nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll" href="#page-top">Nahuel Martinez</a>
        ...
        <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll" href="index.html">Secciones</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll" href="#contact">Mi Historia</a>
                </li>
            </ul>
        </div>
    </div>
...
<!-- ======= Intro Section ======= -->
<div id="home" class="intro route bg-image" style="background-image: url(../assets/img/foto-test.png)">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="copyright-box">
                    <p class="copyright">&copy; Copyright <strong>DCordoba Dev</strong>. All Rights Reserved</p>
                    <div class="credits">
                        <!--
